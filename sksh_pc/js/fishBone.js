$.fn.fishBone = function (data) {
    var colors = ['#F89782', '#1A84CE', '#F7A259', '#43A6DA', '#F9BF3B', '#88C7CC', '#EF6D5F', '#47AADC', '#F03852', '#3A9284'];
            ...
            if (itemclass == 'top') {
                $.each(this, function (name, value) {
                    if (name === "sourceDate") {
                        ...
                        var li = $("<li>" + value + "</li>").css("margin", "0px 0px 0px -60px").css("height", "22px").css("line-height", "35px").css("text-align", "center");//9是原计算结果的偏移量，显示位置正合适
                        li.appendTo(ul);
            ...
            if (itemclass == "bottom") {
                $.each(this, function (name, value) {
                    if (name === "sourceDate") {
                        ...
                        var li = $("<li>" + value + "</li>").css("margin", "0px 0px 0px -60px").css("height", "22px").css("line-height", "10px").css("text-align", "center");//9是原计算结果的偏移量，显示位置正合适
                        li.appendTo(ul);
                        return;
                    }
                });
